...
CREATE TABLE `Client` (
    ...
    UNIQUE INDEX `Client_walletId_key`(`walletId`),
    PRIMARY KEY (`id`)
...
-- AddForeignKey
ALTER TABLE `Client` ADD CONSTRAINT `Client_walletId_fkey` FOREIGN KEY (`walletId`) REFERENCES `Wallet`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
